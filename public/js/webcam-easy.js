class Webcam {
  ...
  selectCamera(flip = null){
    ...
    if (flip && !isFlipped && this.webcamCount > 1) {
      if (this.selectedDeviceIndex >= (this.webcamCount - 1)) {
        this._selectedDeviceId = this.webcamList[this.selectedDeviceIndex - 1].deviceId;
        this._webcamIndex = this.selectedDeviceIndex - 1;
      } else {
        this._selectedDeviceId = this.webcamList[this.selectedDeviceIndex + 1].deviceId;
        this._webcamIndex = this.selectedDeviceIndex + 1;
      }
